...
tar -C dist/ipk/control -cz . >dist/ipk/control.tar.gz
tar -C dist/ipk/data -cz . >dist/ipk/data.tar.gz
tar -C dist/ipk -cz control.tar.gz data.tar.gz debian-binary \
